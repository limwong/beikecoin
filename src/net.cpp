...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BeiKecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"BeiKecointools.com", "10.100.12.121"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"BeiKecointools.com", "testnet-seed.BeiKecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BeiKecoin is probably already running."), addrBind.ToString().c_str());
        else
